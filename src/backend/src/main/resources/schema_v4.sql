...
CREATE TABLE workloads (
    ...
    workload_type       VARCHAR(50) NOT NULL, -- notebook, llm_inference, training,...
    ...
    requested_cpu_limit NUMERIC(10,2) NOT NULL DEFAULT 0,
    requested_memory    BIGINT        NOT NULL DEFAULT 0,   -- MiB
    requested_memory_limit BIGINT     NOT NULL DEFAULT 0,   -- MiB
...
CREATE INDEX idx_workloads_priority_class  ON workloads(priority_class);
