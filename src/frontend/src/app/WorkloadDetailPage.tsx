      ...
      <Card>
        ...
        <CardContent className="text-sm">
          {w.quotaViolations?.length ? (
            ...
            <p className="text-emerald-700">No quota violations recorded.</p>
          )}
        </CardContent>
      </Card>
    </div>
